...
execute positioned ~ ~ ~ run function ua:soulforge/check_resources_activator
execute positioned ~ ~ ~ run function ua:soulforge/check_resources_reset
...
execute if score forge_action unique_artefacts matches 1 positioned ~ ~ ~ run function ua:soulforge/action/summon_book
execute if score forge_action unique_artefacts matches 2 positioned ~ ~ ~ run function ua:soulforge/action/retrieve_artifact
execute if score forge_action unique_artefacts matches 3 positioned ~ ~ ~ run function ua:soulforge/action/summon_activator
execute if score forge_action unique_artefacts matches 4 positioned ~ ~ ~ run function ua:soulforge/action/reset_artefact

execute as @a[tag=soulforge_interaction] run tellraw @a[tag=ua_debug] [{"text":"[UA_debug] Игрок ","color":"gold"},{"selector":"@s","color":"green"},{"text":" Взаимодействовал с мини кузней душ! Тип взаимодействия: ","color":"gold"},{"score":{"name":"forge_action","objective":"unique_artefacts"},"color":"green"}]
